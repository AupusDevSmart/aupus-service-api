...
export class VeiculosService {
  ...
  async criar(createDto: CreateVeiculoDto, user?: ScopedUser): Promise<VeiculoResponseDto> {
    ...
    const veiculo = await this.prisma.veiculo.create({
      data: {
        ...
        seguradora: createDto.seguradora,
        vencimento_seguro: createDto.vencimentoSeguro,
  ...
  async atualizar(id: string, updateDto: UpdateVeiculoDto, user?: ScopedUser): Promise<VeiculoResponseDto> {
    ...
    const veiculo = await this.prisma.veiculo.update({
      ...
      data: {
        ...
        seguradora: updateDto.seguradora,
        vencimento_seguro: updateDto.vencimentoSeguro,
  ...
  private mapearParaResponse(veiculo: any): VeiculoResponseDto {
    return {
      ...
      vencimentoSeguro: veiculo.vencimento_seguro,
